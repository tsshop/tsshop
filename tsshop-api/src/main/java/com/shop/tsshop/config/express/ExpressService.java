package com.shop.tsshop.config.express;
...
public class ExpressService {
    ...
    public ExpressService(String reqURL) {
        ReqURL = reqURL;
    }
     ...
     * @return
     */
    public ExpressDTO getExpressInfo(String OrderCode, String ShipperCode, String LogisticCode) {
        try {
            String result = getOrderTracesByJson(OrderCode, ShipperCode, LogisticCode);
            ObjectMapper objMap = new ObjectMapper();
            ExpressDTO ei = objMap.readValue(result, ExpressDTO.class);
            ei.setShipperName(ExpressEnum.getMsg(ShipperCode));
            return ei;
        } catch (Exception e) {
