...
import com.shop.tsshop.web.mapper.TsshopConfigStorageMapper;
import com.shop.tsshop.web.model.domain.TsshopConfigStorage;
import com.shop.tsshop.web.model.domain.param.AliOssConfigParams;
...
public class OssUtil {
    ...
    public Map<String, String> payFileUpload(AliOssConfigParams aliParams,MultipartFile file, String path) {
    ...
    public void deleteFile(AliOssConfigParams aliOssConfigParams,String src) {
        ...
        ossClient.deleteObject(aliOssConfigParams.getBucketName(), src);
        ossClient.shutdown();
    }

    public void deleteFileList(AliOssConfigParams aliOssConfigParams,List<String> keys) {
        OSS ossClient = new OSSClientBuilder().build(aliOssConfigParams.getEndpoint(),aliOssConfigParams.getAccessKeyId(),aliOssConfigParams.getAccessKeySecret());

        DeleteObjectsResult deleteObjectsResult = ossClient.deleteObjects(new DeleteObjectsRequest(aliOssConfigParams.getBucketName()).withKeys(keys).withEncodingType(URL_ENCODING));
...
// 关闭OSSClient。
    ...
    public String uploadFile(AliOssConfigParams aliOssConfigParams,String address, InputStream inputStream) {
        OSS ossClient = new OSSClientBuilder().build(aliOssConfigParams.getEndpoint(),aliOssConfigParams.getAccessKeyId(),aliOssConfigParams.getAccessKeySecret());
        ossClient.putObject(aliOssConfigParams.getBucketName(), address, inputStream);
        ossClient.shutdown();
        return address;
    }
    ...
    public void copyFile(AliOssConfigParams aliOssConfigParams,String sourceKey, String destinationKey, int time) throws ParseException {
        OSS ossClient = new OSSClientBuilder().build(aliOssConfigParams.getEndpoint(),aliOssConfigParams.getAccessKeyId(),aliOssConfigParams.getAccessKeySecret());
        CopyObjectRequest request = new CopyObjectRequest(aliOssConfigParams.getBucketName(), sourceKey, aliOssConfigParams.getBucketName(), destinationKey);
